...
| catalog.prestocks.ingest        | DISABLED          | Not started (B03); prestocks.com BLOCKED in B01                                                      | Mint/terms/admission and route verification |
...
| identity.provider.verify        | DISABLED          | Not started (B02)                                                                                    | Production issuer/app settings verified; no nonproduction bypass |
